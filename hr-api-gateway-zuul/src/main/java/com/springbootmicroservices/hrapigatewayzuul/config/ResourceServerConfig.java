package com.springbootmicroservices.hrapigatewayzuul.config;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public FilterRegistrationBean<CorsFilter> corsFilter() {
		final var bean = new FilterRegistrationBean<CorsFilter>(new CorsFilter(corsConfigurationSource()));
